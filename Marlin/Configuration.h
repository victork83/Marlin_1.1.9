...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 367.49
  #define DEFAULT_bedKi 69.03
  #define DEFAULT_bedKd 489.08
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 141.7 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 1500, 1500, 15, 200 }
...
// 1rate (mm/m) for the first approach when double-probing (MULTIPLE_PROBING == 2)
